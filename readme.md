...
- [driftnet2](https://github.com/jankesec/driftnet2) - Kernel-level network sniffer and credential extractor leveraging eBPF/XDP hooks with zero EDR footprint, parsing 8+ protocols and detecting DNS tunnels in real time.
